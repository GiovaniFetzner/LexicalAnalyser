...
_lr_goto_items = {'program':([0,],[1,]),'statements':([0,34,35,43,],[2,36,37,44,]),'statement':([0,2,34,35,36,37,43,44,],[3,9,3,3,9,9,3,9,]),'expression':([7,8,11,12,20,21,22,23,],[13,16,17,18,28,29,30,31,]),}
...
_lr_productions = [
  ...
  ('statement -> PRINT ( expression ) NEWLINE','statement',5,'p_statement_print','parser_ast.py',71),
